...
> [!warning] Faktencheck
>Dieser Artikel wurde von Gemini geschrieben. Im Faktencheck habe ich ihn zusammen mit Claude überprüft und weiterentwickelt zu [[02 - Künstliche Intelligenz/3- Veröffentlicht/Claude Desktop App (Cowork)- Sicherheit, Privacy, Datenschutz (von Gemini)\|Claude Desktop App (Cowork)- Sicherheit, Privacy, Datenschutz (von Gemini)]].
