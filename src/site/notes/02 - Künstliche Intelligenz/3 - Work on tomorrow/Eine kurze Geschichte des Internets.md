...
> 
   ![Terminal.png](/img/user/Terminal.png)
>
> Ganz verschwunden ist das Terminal übrigens nie: Als Programm steckt es bis heute in jedem Computer. Für Programmierer gehört es zum Alltag, und mit der zunehmenden Popularität von [[02 - Künstliche Intelligenz/4 - very soon/Vibecoding\|Vibecoding]] entdecken es auch mehr und mehr Nicht-Techies.
...
- **1996 – Schönes Design für alle:** Im Browserkrieg sieht dieselbe Webseite im Netscape Navigator oft ganz anders aus als im Internet Explorer. Die Lösung heißt [[02 - Künstliche Intelligenz/3 - Work on tomorrow/CSS (Cascading Style Sheets)\|CSS]]: eine gemeinsame Sprache für Farben, Schriften und Anordnung, die alle Browser verstehen. HTML nun ausschließlich für die Struktur zuständig, CSS für das Aussehen.
...
[^Paul-Baran]: 🕵️ Baran arbeitete bei der RAND Corporation, einer Denkfabrik, die vor allem für die US-Luftwaffe forschte. Seine Pläne für ein solches ausfallsicheres Netz legte er dem Telefonkonzern AT&T vor, doch der hielt sie für unbrauchbar und lehnte ab. Fast zur selben Zeit kam in England der Informatiker Donald Davies unabhängig auf die Idee der Paketvermittlung, ganz ohne Atomkrieg im Hinterkopf: Er wollte Computer schlicht schneller und effizienter miteinander verbinden. Von ihm stammt auch das Wort „Paket“. Die Macher des ARPANET erfuhren übrigens erst 1967 über Davies' Team von Barans Arbeit.
