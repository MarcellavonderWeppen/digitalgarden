...
Sie beschreibt Ansätze der künstlichen Intelligenz, die auf **Wahrscheinlichkeit, Statistik und Datenanalyse** basieren – im Gegensatz zur [[02 - Künstliche Intelligenz/Garten erkunden/Grundlagen KI/Klassische KI\|klassischen KI]].
...
- Ab 1943 erste Konzepte [[02 - Künstliche Intelligenz/5 - soon (veröffentlicht)/Machine Learning (ML)#Neuronale Netze\|künstlicher Neuronen]] → 1958 folgte mit dem Perceptron das erste lernfähige Netz
- Verstärktes Interesse an statistischen Methoden ab den späten 1980er Jahren, als die klassische KI an ihre Grenzen stieß
- Starker Aufschwung: **1990er bis heute**
- Durchbruch: 2012 mit [[02 - Künstliche Intelligenz/5 - soon (veröffentlicht)/Machine Learning (ML)#Deep Learning\|Deep Learning]]
...
- **[[02 - Künstliche Intelligenz/0 - Final Check/Algorithmus\|Algorithmen]]** und Trainingsmethoden (z.B. der Durchbruch beim Training tiefer neuronaler Netze), um die vorhandenen Daten und die gegebene Rechenleistung optimal zu nutzen
...
Ein Chatbot, der zum Recherchieren eine Datenbank abfragt oder zum Rechnen Code ausführt, ist genau so ein Hybrid.
