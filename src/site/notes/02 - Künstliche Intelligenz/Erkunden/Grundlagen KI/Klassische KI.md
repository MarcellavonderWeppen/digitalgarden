...
| **Beispiel**         | **Logic Theorist** (1956): bewies mathematische Lehrsätze <br> <br>**MYCIN** (1970er): diagnostizierte bakterielle Infektionen und empfahl passende Antibiotika | **Deep Blue** (1997): schlug Schachweltmeister Kasparow <br> <br>**Dijkstra-Algorithmus** (1959): Grundlage moderner Routenplanung von Google Maps bis zum Navi |
