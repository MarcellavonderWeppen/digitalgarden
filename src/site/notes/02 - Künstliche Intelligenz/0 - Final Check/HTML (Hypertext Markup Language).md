...
Öffnen wir eine Webseite im Browser, erscheint eine `<h1>`-Überschrift allerdings groß und fett, Links blau und unterstrichen. Das liegt nicht an HTML, sondern an den Standardeinstellungen des Browsers: Er gibt jedem Element eine Grundgestaltung mit, solange nichts anderes festgelegt ist. Mit CSS können wir das nach Belieben ändern.
...
So könnte unser HTML-Beispiel von oben aussehen, wenn wir es mit CSS eigenwillig gestalten:
