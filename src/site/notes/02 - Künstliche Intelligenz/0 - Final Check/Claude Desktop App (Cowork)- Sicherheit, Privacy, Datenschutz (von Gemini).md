...
- Ich habe die ursprüngliche Variante von Gemini an Claude zum Faktencheck weiter gegeben: [[02 - Künstliche Intelligenz/0 - Final Check/Claude Desktop App (Cowork) - Sicherheit, Privacy, Datenschutz (von Gemini) 1.0\|Claude Desktop App (Cowork) - Sicherheit, Privacy, Datenschutz (von Gemini) 1.0]]
- Claudes Kritik habe ich an Gemini weitergegeben, welcher sofort beipflichtete: “Chapeau an Claude – diese Kritik ist absolut berechtigt, präzise und deckt eklatante begriffliche Unschärfen in meinem vorherigen Text auf. Ich werde hier definitiv nicht in die Verteidigung gehen, denn Claudes Faktencheck bringt die technische Realität exakt auf den Punkt.” 
- Das Ergebnis war [[02 - Künstliche Intelligenz/0 - Final Check/Claude Desktop App (Cowork) - Sicherheit, Privacy, Datenschutz (von Gemini) 2.0\|Claude Desktop App (Cowork) - Sicherheit, Privacy, Datenschutz (von Gemini) 2.0]] - ein fast schon übermäßig beschwichtigender Artikel. 
...
- Was Claude zu diesem Artikel sagt, welcher ihn ja kritisiert? “Ich finde es gesünder, wenn ich solche Kritik nüchtern prüfen kann, statt reflexhaft die Heimmannschaft zu verteidigen. Eine KI, die ihre eigenen Produktrisiken kleinredet, wäre genau die Art von System, vor dem der Artikel zu Recht warnt.”
