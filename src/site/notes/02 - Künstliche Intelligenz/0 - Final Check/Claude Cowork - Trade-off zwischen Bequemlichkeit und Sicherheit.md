---
{"title":"Claude Cowork - Trade-off zwischen Bequemlichkeit und Sicherheit","aliases":null,"tags":null,"gen_ai_anteil":["Mistral 60%","Claude 40%"],"created":"2026-06-15","updated":null,"status":null,"dg-publish":true,"permalink":"/02-kuenstliche-intelligenz/0-final-check/claude-cowork-trade-off-zwischen-bequemlichkeit-und-sicherheit/","dgPassFrontmatter":true,"dg-note-properties":{"title":"Claude Cowork - Trade-off zwischen Bequemlichkeit und Sicherheit","aliases":null,"tags":null,"gen_ai_anteil":["Mistral 60%","Claude 40%"],"created":"2026-06-15","updated":null,"status":null}}
---
...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[[02 - Künstliche Intelligenz/0 - Final Check/Prompt Injection\|Prompt Injection]]** | Versteckte Befehle in Dateien, E-Mails oder Webseiten können Claude zu **unerwünschten Aktionen** verleiten. Anthropic scannt **während Computer Use** auf Prompt Injection, was das Risiko **reduziert, aber nicht eliminiert**.                                                                                                                                        | Datenübertragung, Öffnen lokaler Dateien oder Ausführung schädlicher Skripte. **Systemisches Risiko**, das nicht vollständig vermeidbar ist.                            |
...
- Diesen Prozess zweimal wiederholt; das Ergebnis dürfte ein Artikel sein, der inhaltlich einigermaßen belastbar ist. 
...
Es gibt letztlich keinen Ersatz für echtes menschliches Verständnis. 

Um dieses Verständnis zu erlangen, können [[02 - Künstliche Intelligenz/3- Veröffentlicht/LLMs (Large Language Models)\|LLMs]] ein hilfreiches Werkzeug sein, aber während man auf diesem Weg ist, sollten kritisches Denken, ständiges Prüfen und Hinterfragen die Wegbegleiter sein. 