...
- Die mathematischen Grundlagen (Wahrscheinlichkeitsrechnung) reichen bis ins 17. Jahrhundert zurück
- Verstärktes Interesse an statistischen Methoden in der KI ab den späten 1980er Jahren, als die [[02 - Künstliche Intelligenz/0 - Final Check/Klassische KI\|klassische KI]] an ihre Grenzen stieß
- Starker Aufschwung: **1990er bis heute**
- Durchbruch: 2012 mit [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Machine Learning (ML)#Deep Learning\|Deep Learning]]

## Voraussetzungen

Die datengetriebene KI konnte ihren Siegeszug keinen Augenblick früher antreten, denn ermöglicht wurden ihr immenser Fortschritt erst durch:

-  Verfügbarkeit großer Datenmengen („Big Data“)
- Rechenleistung, um diese Datenmengen verarbeiten zu können („Compute“)
- [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Algorithmus\|Algorithmen]] und Trainingsmethoden (z.B. der Durchbruch beim Training tiefer neuronaler Netze), um die vorhandenen Daten und die gegebene Rechenleistung optimal zu nutzen.
...
- In diesem Zusammenhang fällt auch oft der Begriff [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Machine Learning (ML)\|Machine Learning (ML)]] als praktische Umsetzung der statistischen KI. [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Machine Learning (ML)#Neuronale Netze\|Neuronale Netze]] sind eine Unterkategorie von ML.