---
{"title":"Machine Learning (ML)","aliases":["Machine Learning","ML"],"tags":null,"gen_ai_anteil":null,"created":"2026-06-14","updated":null,"status":null,"dg-publish":true,"permalink":"/02-kuenstliche-intelligenz/4-veroeffentlicht-last-check/machine-learning-ml/","dgPassFrontmatter":true,"dg-note-properties":{"title":"Machine Learning (ML)","aliases":["Machine Learning","ML"],"tags":null,"gen_ai_anteil":null,"created":"2026-06-14","updated":null,"status":null}}
---

# Was ist Machine Learning (ML)?

Machine Learning (ML) ist keine eigenständige Disziplin, sondern Teil eines größeren Denkmodells: der [[02 - Künstliche Intelligenz/0 - Final Check/Statistische KI\|statistischen KI]]. Es setzt dieses [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Paradigma (Denkmodell)\|Paradigma]] in konkrete [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Algorithmus\|Algorithmus]] um - Verfahren, die aus Daten lernen, statt nach vorgegebenen Regeln zu arbeiten.
...
- ML ist also eine Umsetzung statistischer KI - in Form von [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Algorithmus\|Algorithmus]], wie sie z.B. hinter Sprachmodellen wie ChatGPT arbeiten.
...
>- Statistische KI ist das übergeordnete [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Paradigma (Denkmodell)\|Paradigma (Denkmodell)]]
...
Hier der Deep Dive von [[02 - Künstliche Intelligenz/3 - Work on tomorrow/Andrej Karpathy\|Andrej Karpathy]] zum Thema, für alle, die das Thema wirklich in der Tiefe verstehen wollen:
