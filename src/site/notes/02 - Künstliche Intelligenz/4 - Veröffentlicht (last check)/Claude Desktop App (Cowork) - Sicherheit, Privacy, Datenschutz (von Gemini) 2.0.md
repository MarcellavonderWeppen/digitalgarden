---
{"title":"Claude Desktop App (Cowork) - Sicherheit, Privacy, Datenschutz (von Gemini) 2.0","aliases":null,"tags":null,"gen_ai_anteil":["Gemini 60%","Claude 40%"],"created":"2026-06-15","updated":"2026-06-16","status":null,"dg-publish":true,"permalink":"/02-kuenstliche-intelligenz/4-veroeffentlicht-last-check/claude-desktop-app-cowork-sicherheit-privacy-datenschutz-von-gemini-2-0/","dgPassFrontmatter":true,"dg-note-properties":{"title":"Claude Desktop App (Cowork) - Sicherheit, Privacy, Datenschutz (von Gemini) 2.0","aliases":null,"tags":null,"gen_ai_anteil":["Gemini 60%","Claude 40%"],"created":"2026-06-15","updated":"2026-06-16","status":null}}
---

> [!info] Zwischenversion  
Diese Fassung entstand aus dem [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Claude Desktop App (Cowork) - Sicherheit, Privacy, Datenschutz (von Gemini) 1.0\|ursprünglichen Artikel von Gemini]] nach dem Faktencheck durch Claude. Dabei hat sie allerdings ihren kritischen Geist verloren und beschwichtigt zu stark. Den kritischen Blick - diesmal auf dem Boden der Tatsachen - habe ich erst in der [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Claude Desktop App (Cowork)- Sicherheit, Privacy, Datenschutz (von Gemini)\|überarbeiteten Fassung]] wiederhergestellt.
