...
Open Source bedeutet, dass der Quellcode einer Anwendung öffentlich einsehbar ist. Im Allgemeinen wird dieser Code kostenlos der Allgemeinheit zur Verfügung gestellt und ist damit ein [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Common Good (Gemeingut)\|Common Good]]. Ein solches Gemeingut wird von Einzelpersonen oder Teams gepflegt, aber jeder kann Vorschläge zur Verbesserung einreichen. Das hat auch den Vorteil, dass Fehler schneller entdeckt und Sicherheitslücken behoben werden können.
...
- **Keine Abhängigkeit vom Hersteller**: Selbst wenn eine Firma den Support einstellt oder pleitegeht, bleibt der Code erhalten und kann von anderen weiterentwickelt werden. Kein [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/Vendor-Lock-in\|Vendor-Lock-in]].
...
- **Benutzerfreundlichkeit**: Kommerzielle Produkte investieren oft massiv in [[02 - Künstliche Intelligenz/3 - Work on tomorrow/UX\|UX]] und Design. Die Oberfläche ist poliert, die Einrichtung intuitiv.
...
📖 Zusammenfassung zu Morpheus’ Video: [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/KI und Open Source\|KI und Open Source]]
