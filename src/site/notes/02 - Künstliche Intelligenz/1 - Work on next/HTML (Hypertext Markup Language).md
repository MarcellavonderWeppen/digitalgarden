...
Das „H“ in HTML steht für **Hypertext**. Das ist Text, der nicht nur gelesen werden kann, sondern Verknüpfungen zu anderen Texten oder Inhalten enthält. 

Während man ein klassisches Buch meist von vorne nach hinten liest (linear), erlaubt Hypertext ein **nicht-lineares** Lesen. Du springst per Klick von einem Thema zum nächsten, genau so, wie du es gerade im Internet tust.
