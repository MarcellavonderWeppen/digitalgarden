...
Ohne CSS würden das gesamte Internet noch immer wie in den 90zigern aussehen:
...
Das bedeutet: "Mache alle Überschriften (`h1`) blau und gib ihnen eine Größe von 20 Pixeln."

## Warum zwei Sprachen?

An diesem Punkt stellt sich vielleicht die Frage, wozu zwei Programmiersprachen? Warum HTML und CSS, hätte man nicht auch eine Sprache erfinden können die alles kann?
...
Man stelle sich eine Webseite mit hunderten Unterseiten vor. Jede Unterseite hat eine große blaue Überschrift wie in unserem Code-Beispiel oben. Nun entscheidet sich der Besitzer, er möchte aber eine rote Überschrift. 

Wären HTML und CSS in einer Sprache verschmolzen, müssten wir nun von Hand auf hunderten Seiten die Überschrift von blau auf rot umstellen. 

Aber zum Glück gibt es CSS!

Eine einzige CSS-Datei kann mit beliebig vielen Unterseiten verknüpft sein. 

Wir ändern einfach einmal die CSS-Regel: 
...
Ganz richtig. HTML gibt der Seite Struktur, CSS ein schickes Aussehen und JavaScript ist für Interaktivität zuständig. 
