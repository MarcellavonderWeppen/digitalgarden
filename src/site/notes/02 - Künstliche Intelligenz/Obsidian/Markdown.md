...
Im Gegensatz zu Auszeichnungsprachen wie [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/HTML (Hypertext Markup Language)\|HTML (Hypertext Markup Language)]] verzichtet Markdown auf überflüssigen Ballast und konzentriert sich auf den Inhalt.
...
Man sieht: [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/HTML (Hypertext Markup Language)\|HTML]] lässt sich immer noch lesen, erfordert aber schon mehr Kenntnisse und enthält mehr “Ballast”.
...
Das Veröffentlichen meines Digital Gardens hier könnte nicht leichter sein: Ich tippe meine Texte lokal auf meinem Computer in Obsidian, ich klicke auf Veröffentlichen, fertig. Ein Plugin übersetzt das Markdown fehlerfrei in [[02 - Künstliche Intelligenz/4 - Veröffentlicht (last check)/HTML (Hypertext Markup Language)\|HTML]].
